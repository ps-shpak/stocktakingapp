 ...
 * @return {string}
 */
proto.stocktakingapi.ListOwnersResponse.Result.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.stocktakingapi.ListOwnersResponse.Result.prototype.setUserId = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
